...
class TicTac:
    ...
    def check(self):
        ...
        for i in range(50, 350, 100):
            if mouse[0] > i and mouse[1] > 50 and mouse[0] < i+100 and mouse[1] < 150:
                pygame.draw.rect(gameDisplay, green, [i, 50, 100, 100])
                if click[0] == 1:
            ...
            if mouse[0] > i and mouse[1] > 150 and mouse[0] < i+100 and mouse[1] < 250:
                pygame.draw.rect(gameDisplay, green, [i, 150, 100, 100])
                if click[0] == 1:
            ...
            if mouse[0] > i and mouse[1] > 250 and mouse[0] < i+100 and mouse[1] < 350:
                pygame.draw.rect(gameDisplay, green, [i, 250, 100, 100])  
                if click[0] == 1:
    ...
    def gameTie(self):
        ...
        rect.center = (200, 25)
        gameDisplay.fill(white)
        pygame.draw.rect(gameDisplay, red, [50, 50, 300, 300])
        self.drawLine()
        self.textShower()        
        gameDisplay.blit(text_, rect)
        pygame.display.update()
